...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://192.168.0.224:8016/dev/WebClub/uploads/ckfinder/', // '/ckfinder/userfiles/',
    //'root'         => './uploads/'.$this->session->userdata('nit').'/ckfinder/userfiles/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
