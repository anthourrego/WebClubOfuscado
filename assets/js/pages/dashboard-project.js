...
function floatchart() {
    ...
    $(function() {
        ...
        const element = document.querySelector("#sec-ecommerce-chart-line");
        if (element) {
    ...
    $(function() {
        ...
        const element = document.querySelector("#sec-ecommerce-chart-bar");
        if (element) {
            var chart = new ApexCharts(element, options);
            chart.render();    
        }
    ...
    $(function() {
        ...
        const element = document.querySelector("#sec-ecommerce-chart-line1");
        if (element) {
            var chart = new ApexCharts( element , options);
            chart.render();
        }
    ...
    $(function() {
        ...
        const element = document.querySelector("#sec-ecommerce-chart-bar1");
        if (element) {
            var chart = new ApexCharts(element, options);
            chart.render();
        }
